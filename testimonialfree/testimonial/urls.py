...
urlpatterns = [
    ...
    path('view-testimonial-campaign/<int:campaign_id>/', views.view_testimonial_campaign, name='view_testimonial_campaign'),
    path('edit-testimonial-campaign/<int:campaign_id>/', views.edit_testimonial_campaign, name='edit_testimonial_campaign'),
